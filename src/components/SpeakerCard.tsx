    ...
    return(
        <div className="cursor-pointer flex flex-col items-center gap-4 group">
            <div className="relative h-1/3 z-1">
                ...
                mx-auto group-hover:scale-105 transition-transform duration-300 object-cover"
                />
                </div>
                <div className="cursor-pointer flex flex-col items-center h-2/3 border-4 border-red-900 w-full p-4 rounded-lg relative py-10 shadow-xl
                    ...
                    transition-all duration-300">
                        //card overlay
                    <div className="absolute bottom-0 px-4 py-6 rounded-e-lg w-full
                    ...
                    justifiy-center p-4 flex flex-col gap-2">
